...
class _FinalViewState extends State<FinalView> with TickerProviderStateMixin {
  //Es para declarar variables que se inicializarán más adelante.
  //Estas se denominan variables que no aceptan valores NULL, ya que
  //se inicializan después de la declaración.
